...
class Indexer:
    ...
    def __init__(self, A, B, C, z, w=None, x=None):
        ...
        ## Create the domain for the witness vector
        H = self.index_group_vector(len(z))
        ## Create the domain for the private subset of the witness vector
        W = self.index_group_vector(len(w))
        ## Create the domain for the public subset of the witness vector
